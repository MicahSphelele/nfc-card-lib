...
import com.nfc.cardlib.exceptions.TlvException;
...
public final class TlvUtil {
    ...
    public static String prettyPrintAPDUResponse(final byte[] data, final int indentLength) {
        ...
        while (stream.available() > 0) {
            ...
            buf2.append(BytesUtils.bytesToStringNoSpace(tagBytes));
            buf2.append(BytesUtils.bytesToStringNoSpace(lengthBytes));
            buf2.append(BytesUtils.bytesToStringNoSpace(valueBytes));
            buf2.append(" | ");
